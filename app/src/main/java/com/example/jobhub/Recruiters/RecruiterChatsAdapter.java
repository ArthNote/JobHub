...
public class RecruiterChatsAdapter extends RecyclerView.Adapter<RecruiterChatsAdapter.MyViewHolder> {
    ...
    public RecruiterChatsAdapter (Activity activity, Context context, ArrayList<Chat> chatList, Database db, String user_id){
    ...
    @NonNull
    @Override
    public RecruiterChatsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecruiterChatsAdapter.MyViewHolder holder, int position) {
        Chat cList = chatList.get(position);
        holder.chat_row_name.setText(String.valueOf(cList.getCname()));
        String cid = String.valueOf(cList.getCid());
        String fid = db.getUserFId(cid);
        String gender = db.getUserGender(String.valueOf(cList.getCid()));
        ...
        holder.chat_row_linearlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, RecruiterChat.class);
