...
import com.example.jobhub.Recruiters.RecruiterChat;
...
public class CandidateChat extends AppCompatActivity {
        ...
        send_msg_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!msg.equals("")){
                    ...
                    Toast.makeText(CandidateChat.this, "you cant send empty messages", Toast.LENGTH_SHORT).show();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if (msg != null && msg.getReceiver() != null && msg.getSender() != null) {
                        ...
                        Toast.makeText(CandidateChat.this, "null", Toast.LENGTH_SHORT).show();
                    }
                }
            }
